REVOKE EXECUTE ON FUNCTION public.anansi_web_bump(jsonb) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.mo_hyperfold_bump(jsonb) FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.anansi_web_bump(jsonb) TO service_role;
